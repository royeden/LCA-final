...
#   -frame_duration (Opus Codec specific) 5 (5ms per frame, could be changed to 10, 15 or 20)
...
#   -frame_duration (específico para el Codec Opus) 5 (5ms por ventana, podría cambiarse a 10, 15 o 20)
